...
lyr_Bingmaps_0.setVisible(true);lyr_amphoe_1.setVisible(true);lyr_water_way_2.setVisible(true);lyr_village_3.setVisible(true);
var layersList = [lyr_Bingmaps_0,lyr_amphoe_1,lyr_water_way_2,lyr_village_3];
